...
var creatorList = ['@riski','@rizzgans','@riskinihbos','@zahiranjay', '@riskiganssss','@riakiganteng','@riskigantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'riskigans') return res.json(loghandler.invalidKey)
